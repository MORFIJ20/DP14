...
class DevicesListFragment : Fragment(), ItemAdapter.Listener {
        ...
        binding.imBluetoothSearch.setOnClickListener {
            try {
                if (bAdapter?.isEnabled == true) {
                    ...
                    binding.bpSearch.visibility = View.VISIBLE
                }
    ...
    private fun initRcViews() = with(binding){
        ...
        itemAdapter = ItemAdapter(this@DevicesListFragment, false)
        discoveryAdapter = ItemAdapter(this@DevicesListFragment, true)
        ...
        override fun onReceive(p0: Context?, intent: Intent?) {
           ...
           try{
               Log.d("MyLog", "Devices: ${device?.name}")
                ...
                binding.bpSearch.visibility = View.GONE
            }
        }
